 ...
 * Only the 20 test hotels may be processed until the phase is approved.
...
export function automationBlockedReason(slug?: string | null): string | null {
  ...
  return "Automation is paused during the data-correction phase. Pass hotel_slug for one of the 20 test hotels.";
}
