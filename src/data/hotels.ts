...
export const creteTop15: Hotel[] = [
  { rank: 1, name: "Elounda Mare Relais & Châteaux", neighborhood: "Elounda", score: 9.5, pricePerNight: "from €520", poolType: "Private bungalow pools · seawater main pool", highlight: "Private pools above Mirabello Bay", description: "Bungalows with their own heated seawater pools stepped down toward the bay, plus a large seawater main pool framed by bougainvillea.", vibe: "Classic Greek luxury, quiet, grown-up", bestTime: "May–October", tags: ["resort", "quiet", "spa"], subscores: { view: 9.6, size: 9.0, loungers: 9.4, service: 9.7, wow: 9.3 } },
  { rank: 2, name: "Blue Palace, a Luxury Collection Resort", neighborhood: "Elounda", score: 9.4, pricePerNight: "from €480", poolType: "Infinity pool · private villa pools", highlight: "Infinity edge facing Spinalonga", description: "A terraced hillside of private pools ending in an infinity deck that looks straight across the water to Spinalonga island.", vibe: "Polished, romantic, island views", bestTime: "May–October", tags: ["resort", "spa"], subscores: { view: 9.7, size: 8.8, loungers: 9.2, service: 9.4, wow: 9.4 } },
  { rank: 3, name: "Domes Zeen Chania, a Luxury Collection Resort", neighborhood: "Chania / Kalamaki", score: 9.2, pricePerNight: "from €430", poolType: "Lagoon-style main pool · private pools", highlight: "Beachfront lagoon pool under palms", description: "A low-slung, garden-heavy resort where the main pool curves through palms a few steps from the sand.", vibe: "Barefoot design, family-friendly", bestTime: "May–October", tags: ["resort", "spa"], subscores: { view: 9.0, size: 9.2, loungers: 9.3, service: 9.2, wow: 9.0 } },
  { rank: 4, name: "Nana Princess Suites, Villas & Spa", neighborhood: "Hersonissos", score: 9.1, pricePerNight: "from €400", poolType: "Private heated pools · beachfront pools", highlight: "Almost every suite has its own pool", description: "An adults-oriented beachfront resort built around private heated pools, with sea-facing decks and an oversized spa.", vibe: "Modern, indulgent, couples", bestTime: "April–October", tags: ["resort", "spa"], subscores: { view: 8.8, size: 8.9, loungers: 9.2, service: 9.2, wow: 9.1 } },
  { rank: 5, name: "Daios Cove Luxury Resort & Villas", neighborhood: "Agios Nikolaos", score: 9.0, pricePerNight: "from €420", poolType: "Cliffside main pool · private villa pools", highlight: "A private cove and a wall of pools", description: "Villas cascade down a cliff into a private cove, each with its own pool, above a large sea-level main pool and beach club.", vibe: "Dramatic, secluded, design-led", bestTime: "May–October", tags: ["resort", "quiet"], subscores: { view: 9.5, size: 8.8, loungers: 9.0, service: 8.9, wow: 9.2 } },
  { rank: 6, name: "Amirandes Grecotel Boutique Resort", neighborhood: "Gouves", score: 8.9, pricePerNight: "from €380", poolType: "Lagoon pool · Olympic-length pool", highlight: "Vast lagoon pool that wraps the resort", description: "A saltwater lagoon pool weaves between villas and gardens, alongside a serious lap pool right by the beach.", vibe: "Family resort with grand scale", bestTime: "May–October", tags: ["resort"], subscores: { view: 8.6, size: 9.5, loungers: 9.0, service: 8.8, wow: 8.7 } },
  { rank: 7, name: "Abaton Island Resort & Spa", neighborhood: "Hersonissos", score: 8.8, pricePerNight: "from €360", poolType: "Infinity pools · private suite pools", highlight: "Layered infinity pools over the Cretan Sea", description: "Stacked infinity decks and dozens of private pools on a rocky headland, with a design-forward adults area.", vibe: "Contemporary, stylish, adults-leaning", bestTime: "May–October", tags: ["resort", "spa"], subscores: { view: 9.1, size: 8.6, loungers: 8.8, service: 8.8, wow: 8.9 } },
  { rank: 8, name: "Casa Delfino Hotel & Spa", neighborhood: "Chania Old Town", score: 8.6, pricePerNight: "from €260", poolType: "Rooftop plunge pool · old town view", highlight: "Rooftop plunge above the Venetian harbour", description: "A 17th-century mansion in the old town with a small rooftop plunge pool looking over tiled roofs to the harbour and the White Mountains.", vibe: "Boutique, historic, romantic", bestTime: "May–October", tags: ["rooftop", "quiet"], subscores: { view: 9.0, size: 7.2, loungers: 8.2, service: 9.0, wow: 8.4 } },
  { rank: 9, name: "Cayo Exclusive Resort & Spa", neighborhood: "Plaka, Elounda", score: 8.6, pricePerNight: "from €390", poolType: "Infinity pool · private pools", highlight: "Straight-on Spinalonga sunsets", description: "A small hillside resort in Plaka where the infinity pool and private suite pools all aim at Spinalonga.", vibe: "Intimate, adults-leaning, quiet", bestTime: "May–October", tags: ["quiet", "spa"], subscores: { view: 9.3, size: 8.0, loungers: 8.6, service: 8.7, wow: 8.6 } },
  { rank: 10, name: "Kalimera Kriti Hotel & Village Resort", neighborhood: "Sissi", score: 8.4, pricePerNight: "from €260", poolType: "Multiple outdoor pools · heated indoor pool", highlight: "Pool village on a private bay", description: "A sprawling low-rise resort with a series of connected outdoor pools plus a heated indoor pool for shoulder season.", vibe: "Family, generous, relaxed", bestTime: "April–October", tags: ["resort"], subscores: { view: 8.2, size: 9.0, loungers: 8.6, service: 8.3, wow: 8.0 } },
  { rank: 11, name: "Minos Beach Art Hotel", neighborhood: "Agios Nikolaos", score: 8.3, pricePerNight: "from €280", poolType: "Seafront pool · private bungalow pools", highlight: "Sculpture gardens down to the water", description: "Bungalows scattered through an art-filled seafront garden, with a calm main pool and several private pools by the rocks.", vibe: "Artistic, low-key, grown-up", bestTime: "May–October", tags: ["quiet"], subscores: { view: 8.7, size: 8.0, loungers: 8.3, service: 8.4, wow: 8.2 } },
  { rank: 12, name: "Stella Island Luxury Resort & Spa", neighborhood: "Analipsi, Hersonissos", score: 8.2, pricePerNight: "from €300", poolType: "Swim-up suites · lagoon pool network", highlight: "Adults-only lagoon with swim-up rooms", description: "An adults-only resort built around a lagoon pool network — most suites open directly onto the water.", vibe: "Adults-only, social, party-adjacent", bestTime: "May–October", tags: ["resort", "spa"], subscores: { view: 7.8, size: 8.8, loungers: 8.4, service: 8.2, wow: 8.4 } },
  { rank: 13, name: "Avra Imperial Hotel", neighborhood: "Kolymbari, Chania", score: 8.1, pricePerNight: "from €240", poolType: "Large outdoor pools · heated indoor pool", highlight: "One of Crete's biggest pool decks", description: "Huge freeform pools set in gardens near Kolymbari beach, plus an indoor heated pool and spa for cooler months.", vibe: "Family resort, spacious", bestTime: "April–October", tags: ["resort"], subscores: { view: 7.9, size: 9.1, loungers: 8.5, service: 8.0, wow: 7.9 } },
  { rank: 14, name: "Ammos Hotel", neighborhood: "Chania / Agioi Apostoloi", score: 8.0, pricePerNight: "from €230", poolType: "Outdoor pool · beachfront", highlight: "Colour-pop design pool by the beach", description: "A small, design-driven family hotel with a bright, sheltered pool a few steps from a calm swimming bay.", vibe: "Design, family, easygoing", bestTime: "May–October", tags: ["quiet"], subscores: { view: 8.0, size: 7.6, loungers: 8.2, service: 8.6, wow: 7.8 } },
  { rank: 15, name: "Nautilux Rethymno by Mage Hotels", neighborhood: "Rethymno", score: 7.9, pricePerNight: "from €190", poolType: "Rooftop pool · sea view", highlight: "Rooftop pool over Rethymno", description: "A compact city hotel whose rooftop pool and bar look over Rethymno's beach strip toward the old town.", vibe: "Urban, value, sunset drinks", bestTime: "May–October", tags: ["rooftop"], subscores: { view: 8.4, size: 7.0, loungers: 7.6, service: 8.0, wow: 7.6 } },
];
