...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PoolList — Världens bästa hotellpooler" },
      { property: "og:description", content: "Rankningar av de snyggaste pool-hotellen i Barcelona, Paris, London och New York." },
