...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "PoolList — The world's best hotel pools, ranked" },
      ...
      { property: "og:title", content: "PoolList — The world's best hotel pools, ranked" },
      ...
      { name: "twitter:title", content: "PoolList — The world's best hotel pools, ranked" },
