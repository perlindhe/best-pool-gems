...
function HotelDetailPage() {
  ...
  const keyFacts: string[] = noPool ? [] : [
    ...
    heating === "heated_pool_available" ? "Heated" : null,
    season.status === "year_round_swimming_pool" || season.status === "year_round_spa_pool"
      ? "Year-round"
      : null,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeatedPoolPanel
        ...
        heating={heating}
        seasonSentence={season.sentence}
        pools={poolRecords}
        quotes={quotes}
        status={status}
              ...
              <div className="p-6 md:p-8">
                <PoolRecordsPanel
                  ...
                  counts={{
                    ...
                    plunge_pool_count: hotel.plunge_pool_count,
                ...
                {pools.length === 0 && !noPool && (
                  <p className="mb-4 text-sm text-muted-foreground">
                    We have not yet documented the individual pools at this hotel. Nothing below is
                    estimated — missing details are shown as not confirmed.
                  </p>
                )}
